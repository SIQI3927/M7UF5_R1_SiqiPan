...
using UnityEngine.UI;
    ...
    {
        [HideInInspector] public NetworkVariable<int> n_brushSize = new NetworkVariable<int>();
        [HideInInspector] public NetworkVariable<Color> n_color = new NetworkVariable<Color>();
        ...
        public int brushSizeValue = 5; // Tama�o del pincel
        ...
        void Start()
        {
            //GameSettingsManager.Instance.playerSettings.Board = this;
            InitTexture();
            NewBrushSize();
            EraseDrawServerRpc();
        }
        ...
        private void ApplyPixelsToClientsClientRpc(Vector2Int[] pixels, Color color)
        {
            ...
            {
                //// Convertir las coordenadas UV a p�xeles
                int x = pixel.x;
                int y = pixel.y;
                int px = 0;
                int py = 0;

                // Pintar en la textura dentro del �rea del pincel
        ...
        public void DrawPoint(Vector2 uv, Color color, int brushSize)
        {
            ...
            // Iniciar env�o si no est� en curso
